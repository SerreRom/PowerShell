...
$FileName  = "Audit-S2D-$ClientName-$Date.html"
...
Add-content -Path $ExportLog -Value '<center><span class="AdvertMessage>This board has been generated by PowerShell script written by Romain Serre (@RomSerre) - <a href="https://www.tech-coffee.net" target"_blank">https://www.tech-coffee.net</a></span></center>'
