...
if ($ClusterS2D){
    ...
    $StoragePoolInformation  = Get-StoragePoolInfo -ClusterName $ClusterName -DomaiName $DomainName -Credential $Credential
...
$HTMLEnding = @"
<br><br><br>
<center><span class="$AdvertMessage">This board has been generated by PowerShell script written by Romain Serre (Twitter: @RomSerre) - <a href="https://www.tech-coffee.net" target"_blank">https://www.tech-coffee.net</a></span></center>
</body>
</html>
"@
...
Write-Host "This script has been written by Romain Serre - https://www.tech-coffee.net (Twitter: @RomSerre)" -ForegroundColor Green -BackgroundColor black
